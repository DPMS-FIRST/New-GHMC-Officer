...
class Constants {
  ...
  static List<grievancedetailsresponse.Comments>? commentsItemsList = null;
  ...
  static String grievancedetailslatlon = "";
  static String grievancedetailsphoto = "";
  static String grievancedetailsupdatedstatus = "";
  static String grievancedetailsmobileno = "";
  static String grievancedetailsremarks = "";
