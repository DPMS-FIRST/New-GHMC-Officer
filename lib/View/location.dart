...
class LoactionCheck extends StatefulWidget {
  const LoactionCheck({super.key});

  @override
  State<LoactionCheck> createState() => _LoactionCheckState();
}

class _LoactionCheckState extends State<LoactionCheck> {
