...
import 'package:ghmc_officer/Model/get_lower_staff_response.dart';
import 'package:ghmc_officer/Model/getward_response.dart';
...
class _ApiResponseState extends State<ApiResponse> {
  ...
  GetWardDetails() async {
    const url = ApiConstants.get_ward_baseurl + ApiConstants.get_ward_endpoint;
  ...
  updateGrievanceDetails() async {
    ...
    const url = ApiConstants.update_grievance_base_url +
