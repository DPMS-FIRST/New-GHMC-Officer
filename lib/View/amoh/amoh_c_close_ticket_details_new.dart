                  ...
                  child: Column(
                    children: [
                      RowComponent(
                        ...
                        Constants.amoh_closedticketlist?.tICKETID,
                      ),
                      RowComponent(
                        TextConstants
                            .amoh_c_closed_ticket_details_ticketraiseddate,
                        Constants.amoh_closedticketlist?.tICKETRAISEDDATE,
                      ),
                      RowComponent(
                        TextConstants
                            .amoh_c_closed_ticket_details_ticketcloseddate,
                        Constants.amoh_closedticketlist?.tICKETCLOSEDDATE,
                      ),
                      RowComponent(
                        TextConstants.amoh_c_closed_ticket_details_zone,
                        Constants.amoh_closedticketlist?.zONENAME,
                      ),
                      RowComponent(
                        TextConstants.amoh_c_closed_ticket_details_circle,
                        Constants.amoh_closedticketlist?.cIRCLENAME,
                      ),
                      RowComponent(
                        TextConstants.amoh_c_closed_ticket_details_ward,
                        Constants.amoh_closedticketlist?.wARDNAME,
                      ),
                      RowComponent(
                        TextConstants.amoh_c_closed_ticket_details_loaction,
                        Constants.amoh_closedticketlist?.lOCATION,
                      ),
                      RowComponent(
                        TextConstants.amoh_c_closed_ticket_details_inchargename,
                        Constants.amoh_closedticketlist?.cONCESSIONERNAME,
                      ),
                      RowComponent(
                        TextConstants
                            .amoh_c_closed_ticket_details_Type_of_waste,
                        Constants.amoh_closedticketlist?.tYPEOFWASTE,
                      ),
                      RowComponent(
                          TextConstants
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    VehicleRowComponent(
                                      TextConstants
                                          .amoh_closed_ticket_vehicleno,
                                      details?.vEHICLENO,
                                    ),
                                    VehicleRowComponent(
                                      TextConstants
                                          .amoh_closed_ticket_vehicleid,
                                      details?.vEHICLEID,
                                    ),
                                    VehicleRowComponent(
                                      TextConstants
                                          .amoh_closed_ticket_drivername,
                                      details?.dRIVERNAME,
                                    ),
                                    VehicleRowComponent(
                                      TextConstants.amoh_closed_ticket_driverno,
