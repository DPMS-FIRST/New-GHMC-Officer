...
class SimpleGroupedlist extends StatelessWidget {
  const SimpleGroupedlist({Key? key}) : super(key: key);
...
class CustomPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    List itemlist = ["hii","hello"];
    return Scaffold(
      appBar: AppBar(title: const Text('Custom GroupedListView')),
      body: GroupedListView(
       
        
         items: List<int>.generate(itemlist.length, (index) => index + 1),
