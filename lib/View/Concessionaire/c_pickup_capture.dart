...
import 'package:ghmc_officer/model/c_pickup_capture_submit_res.dart';
...
class _ConcessionairePickupCaptureState
                    ...
                    onPressed: () {
                      if (vehicleNumbersDropdown.value == "Select Vehicle No") {
                        ...
                        if (_image2?.path == null) {
                          showToast("Please select after trip image");
                        } else {
                          submit_yes
                              ? onSubmitYes(
  ...
  getsubmitdetails() async {
    ...
    final payload = {
      "PLANT_ID": plantid,
      "CNDW_GRIEVANCE_ID": Constants.ticktetitemslist?.tICKETID,
  ...
  onSubmitYes(String? sTATUSMESSAGE) {
    showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
  ...
  onSubmitNo(String? sTATUSMESSAGE) {
    showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
