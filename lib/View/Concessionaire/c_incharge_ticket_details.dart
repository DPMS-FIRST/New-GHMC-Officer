            ...
            child: Column(
              children: [
                ...
                RowComponent(TextConstants.c_inchrge_ticket_details_zone,
                    Constants.c_incharge_ticket_list?.zONENAME, Colors.white),
                RowComponent(
                    TextConstants.c_inchrge_ticket_details_circle,
                    Constants.c_incharge_ticket_list?.cIRCLENAME ?? "",
                    Colors.white),
                RowComponent(
                    TextConstants.c_inchrge_ticket_details_ward,
                    Constants.c_incharge_ticket_list?.wARDNAME ?? "",
                    Colors.white),
                RowComponent(
                    TextConstants.c_inchrge_ticket_details_location,
                    Constants.c_incharge_ticket_list?.lOCATION ?? "",
                    Colors.white),
                RowComponent(
                    TextConstants.c_inchrge_ticket_details_citizen_raised_date,
                    Constants.c_incharge_ticket_list?.lANDMARK ?? "",
                    Colors.white),
                RowComponent(
                    TextConstants.c_inchrge_ticket_details_amoh_forward_date,
                    Constants.c_incharge_ticket_list?.aMOHFORWARDEDDATE ?? "",
                    Colors.white),
                RowComponent(
                    TextConstants.c_inchrge_ticket_details_type_of_waste,
                    Constants.c_incharge_ticket_list?.tYPEOFWASTE ?? "",
                    Colors.white),
                ...
                Padding(
                  ...
                  child: Image.network(
                    "${Constants.c_incharge_ticket_list?.iMAGE1PATH}",
                    height: 100.0,
                    width: 100.0,
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                            flex: 1,
                            child: Text(
                                "${Constants.c_incharge_ticket_list_vehicle_list?.vEHICLETYPE}")),
                        Expanded(
                            flex: 2,
                            child: Center(
                                child: Text(
                                    "${Constants.c_incharge_ticket_list_vehicle_list?.nOOFVEHICLES}"))),
                        Expanded(
                            flex: 1,
                            child: Center(
                                child: Text(
                                    "${Constants.c_incharge_ticket_list_vehicle_list?.aMOUNT}"))),
                      ],
                    ),
                  ),
                ),
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                          ...
                          child: TextButton(
                            onPressed: () {
                              double lattitude = double.parse("${Constants.c_incharge_ticket_list?.lATITUDE}");
                                double longitude =
                                   double.parse("${Constants.c_incharge_ticket_list?.lONGITUDE}");
